...
|[Investec CLI Tool](https://youtu.be/-HrEy_8OwgI?t=1116)| | Get accounts, balance and transactions in your CLI.| *Python Tabulate, Python Fire (CLI)* |*[@rpurdon-nf](https://github.com/rpurdon-nf)*|
